...
function Sidebar() {
  ...
  return (
    <div className="relative flex h-screen bg-customBg w-full max-w-[20rem] flex-col p-4 text-gray-700">
      ...
      <button 
        className="lg:hidden absolute top-4 left-4 p-2 rounded-md text-gray-700 hover:bg-blue-500"
      
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
          <path fill-rule="evenodd" d="M4.25 5.25a.75.75 0 0 1 .75-.75h14a.75.75 0 0 1 0 1.5H5a.75.75 0 0 1-.75-.75ZM4.25 12.25a.75.75 0 0 1 .75-.75h14a.75.75 0 0 1 0 1.5H5a.75.75 0 0 1-.75-.75ZM4.25 19.25a.75.75 0 0 1 .75-.75h14a.75.75 0 0 1 0 1.5H5a.75.75 0 0 1-.75-.75Z" clip-rule="evenodd" />
        </svg>
      </button>
      <div className="">
